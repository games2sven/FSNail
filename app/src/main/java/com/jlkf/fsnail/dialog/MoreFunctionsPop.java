...
public class MoreFunctionsPop   {
    ...
    public   MoreFunctionsPop (int  type, Context context, View showView){
        this.type =type;
    ...
    public   void  showPop(){
        ...
        parentView = LayoutInflater.inflate(R.layout.pop_more_functions, null);
     ...
     parentView.findViewById(R.id.iv_search_current).setOnClickListener(new View.OnClickListener() {
         @Override
         public void onClick(View v) {
             if (moreClickListener!=null) {
                 dissMiss();
                 moreClickListener.searchCurren();
             }
         }
     });
        ...
        parentView.findViewById(R.id.iv_lunban).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (moreClickListener!=null) {
                    dissMiss();
                    moreClickListener.lunbanClick();
                }
            }
        });
        showUp2(showView);
    ...
    public void showSingleOneFunction(){
        parentView.findViewById(R.id.iv_search_current).setVisibility(View.GONE);
        parentView.findViewById(R.id.iv_search_all).setVisibility(View.GONE);
    }
