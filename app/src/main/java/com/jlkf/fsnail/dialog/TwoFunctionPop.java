...
public class TwoFunctionPop {
    ...
    public TwoFunctionPop(int type, Context context, View showView) {
        this.type = type;
    ...
    public void showPop() {
        ...
        parentView = LayoutInflater.inflate(R.layout.pop_two_functions, null);
        ...
        parentView.findViewById(R.id.iv_add).setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (moreClickListener != null) {
                    dissMiss();
                    moreClickListener.add();
                }
            }
        });
        showUp2(showView);
