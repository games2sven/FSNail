...
public class CustomNamePop {
    ...
    public CustomNamePop( Context context, View showView){
    ...
    public   void  showPop(String msg){
        ...
        parentView = LayoutInflater.inflate(R.layout.pop_custom_name, null);
        mPopupWindow =new PopupWindow(parentView, ViewGroup.LayoutParams.WRAP_CONTENT,
                ViewGroup.LayoutParams.WRAP_CONTENT, true);
        setPopConfig();
        TextView textView =parentView.findViewById(R.id.tv_pop_customer_name);
