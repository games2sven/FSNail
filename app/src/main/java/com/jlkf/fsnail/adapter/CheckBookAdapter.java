...
public class CheckBookAdapter extends BaseExcelPanelAdapter<RowTitle, ColTitle, Cell> {
    ...
    public CheckBookAdapter(Context context, View.OnClickListener blockListener) {
        super(context);
    ...
    public void onBindCellViewHolder(RecyclerView.ViewHolder holder, int verticalPosition, int horizontalPosition) {
        ...
        if (cell.getStatus() == 0) {
            ...
            viewHolder.cellContainer.setBackgroundColor(ContextCompat.getColor(context, R.color.content_ceil));
        } else {
...
//            roomTypeLabel = (TextView) itemView.findViewById(R.id.room_type_label);
    ...
    public View onCreateTopLeftView() {
        return LayoutInflater.from(context).inflate(R.layout.room_status_left_top_cell, null);
    }
}
