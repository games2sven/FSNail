...
public class TextViewSpinner extends TextView {
    ...
    private TextViewSpinnerAdapter adapter;
    ...
    public TextViewSpinner(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public TextViewSpinner(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        boolean rtl = TextViewUtils.isRtl(context);
        ...
        try {
            ...
            arrowColorDisabled = TextViewUtils.lighter(arrowColor, 0.8f);
        } finally {
            ta.recycle();
        }
        ...
        if (!hideArrow) {
            arrowDrawable = TextViewUtils.getDrawable(context, R.drawable.ms__arrow).mutate();
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (onItemSelectedListener != null) {
                    ...
                    onItemSelectedListener.onItemSelected(TextViewSpinner.this, position, id, item.toString());
                }
            }
        });
...
//    if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP) {
        ...
        popupWindow.setBackgroundDrawable(TextViewUtils.getDrawable(context, R.drawable.ms__drawable));
//    } else {
        ...
        popupWindow.setOnDismissListener(new PopupWindow.OnDismissListener() {
            ...
            public void onDismiss() {
                if (nothingSelected && onNothingSelectedListener != null) {
                    onNothingSelectedListener.onNothingSelected(TextViewSpinner.this);
                }
                if (!hideArrow) {
                    animateArrow(false);
                }
...
//        MenuBean itemText = (MenuBean) adapter.getItem(i);
...
//      }
    ...
    public void setBackgroundColor(int color) {
        ...
        if (background instanceof StateListDrawable) { // pre-L
            try {
                ...
                int[] colors = { TextViewUtils.darker(color, 0.85f), color };
    ...
    public <T> void setItems(@NonNull List<T> items) {
        adapter = new TextViewSpinnerAdapter<>(getContext(), items).setBackgroundSelector(backgroundSelector)
                .setTextColor(textColor);
...
//        this.adapter = new TextViewSpinnerAdapter(getContext(), adapter).setBackgroundSelector(backgroundSelector)
//                .setTextColor(textColor);
//        setAdapterInternal(this.adapter);
     ...
     * @param <T> The type
     */
    public <T> void setAdapter(TextViewSpinnerAdapter<T> adapter) {
    ...
    private void setAdapterInternal(@NonNull TextViewSpinnerAdapter adapter) {
        ...
        if (adapter.getItems().size() > 0) {
            if (nothingSelected && !TextUtils.isEmpty(hintText)) {
                ...
                setTextColor(textColor);
//                String firstText = getText().toString();
//                setText(firstText);
                    setText(adapter.getItem(selectedIndex).toString());
            }
        } else {
    ...
    public interface OnItemSelectedListener<T> {
         ...
         * item.</p>
         *
         * @param view The {@link TextViewSpinner} view
         * @param position The position of the view in the adapter
         * @param id The row id of the item that is selected
         * @param item The selected item
         */
        void onItemSelected(TextViewSpinner view, int position, long id, T item);
    }
    ...
    public interface OnNothingSelectedListener {
         ...
         *
         * @param spinner the {@link TextViewSpinner}
         */
        void onNothingSelected(TextViewSpinner spinner);
    }
